...
{
    public partial class Manager_Classes12 : Form
    {
        public Manager_Classes12()
        {
            InitializeComponent();
        }
        private void Sinif9OgrencileriListele()
        {
            ...
            using (SqlConnection conn = new SqlConnection(connectionString))
            {
                ...
                {
                    cmd.Parameters.AddWithValue("@sinif", "12");
        ...
        private void Manager_Classes12_Load(object sender, EventArgs e)
        {
