...
{
    public partial class Manager_Classes10 : Form
    {
        public Manager_Classes10()
        {
            InitializeComponent();
        }
        private void Sinif9OgrencileriListele()
        {
            ...
            using (SqlConnection conn = new SqlConnection(connectionString))
            {
                ...
                {
                    cmd.Parameters.AddWithValue("@sinif", "10");
        ...
        private void Manager_Classes10_Load(object sender, EventArgs e)
        {
