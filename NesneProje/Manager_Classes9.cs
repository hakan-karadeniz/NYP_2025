...
{
    public partial class Manager_Classes9 : Form
    {
        public Manager_Classes9()
        {
            InitializeComponent();
        }
        private void Sinif9OgrencileriListele()
        {
            ...
            using (SqlConnection conn = new SqlConnection(connectionString))
            {
                ...
                {
                    cmd.Parameters.AddWithValue("@sinif", "9");
        ...
        private void Manager_Classes9_Load(object sender, EventArgs e)
        {
